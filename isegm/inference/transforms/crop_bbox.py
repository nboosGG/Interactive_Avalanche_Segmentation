...
from isegm.utils.misc import clamp_bbox
...
class CropBBox(BaseTransform):
    ...
    def transform(self, image_nd, clicks_lists: List[List[Click]]):
        ...
        #         current_object_roi = get_object_roi(current_pred_mask, clicks_list, self.bbox)
        ...
        current_object_roi = self.bbox
        
        print(current_object_roi)
...
def get_object_roi(pred_mask, clicks_list, bbox):
