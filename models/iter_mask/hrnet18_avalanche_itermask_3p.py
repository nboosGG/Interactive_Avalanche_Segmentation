...
def train(model, cfg, model_cfg):
    ...
    train_augmentator = Compose([
        ...
        ShiftScaleRotate(shift_limit=0.03, scale_limit=0,   #shift default 0.03
    ...
    trainset = DroneAvalancheDataset(
        cfg.ds_v3_0p5m_NoBlur_4_train, #cfg.AVALANCHE_TRAIN, #AVALANCHE_TRAIN
        split='train',
    ...
    valset = DroneAvalancheDataset(
        cfg.ds_v3_0p5m_NoBlur_4_train, #cfg.AVALANCHE_VALI, #AVALANCHE_VALI
        split='val',
